...
/// A style to customize the [NeuProgress]
///
...
///  ```
///
class NeuProgress extends StatefulWidget {
  final double? _percent;
  final double height;
  final Duration duration;
  final NeuProgressStyle style;
  final Curve curve;
  ...
  const NeuProgress(
      ...
      this.style = const NeuProgressStyle(),
      this.curve = Curves.easeOutCubic})
      : this._percent = percent,
        super(key: key);

  @override
  _NeuProgressState createState() => _NeuProgressState();
...
class _NeuProgressState extends State<NeuProgress>
  ...
  @override
  void didUpdateWidget(NeuProgress oldWidget) {
    ...
    return SizedBox(
      ...
      child: FractionallySizedBox(
        ...
        child: Neu(
          ...
          style: NeuStyle(
            boxShape: NeuBoxShape.roundRect(widget.style.borderRadius),
