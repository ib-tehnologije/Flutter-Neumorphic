...
class NeuBigButton extends StatelessWidget {
  ...
  const NeuBigButton(this.title, this.onPressed,
      {Key? key,
      this.color,
      this.left,
      this.right,
    ...
    return Padding(
      padding: EdgeInsets.only(
          ...
          bottom: isAtBottom
              ...
              : paddingBottom),
      child: NeuButton(
        style: (neumorphicStyle ?? GlobalNeuSettings.neumorphicStyle)
            .copyWith(
                color: (color ?? Theme.of(context).colorScheme.primary)
                    .withOpacity(onPressed == null ? 0.5 : 1),
                intensity: 0.6,
                surfaceIntensity: 0.3,
                boxShape: NeuBoxShape.roundRect(BorderRadius.circular(
                    rectRadius ?? GlobalNeuSettings.rectRadius))),
