...
/// A Style to customize the [NeuIndicator]
///
...
enum NeuIndicatorOrientation { vertical, horizontal }

/// An indicator is a horizontal / vertical bar that display a percentage
///
/// Like a ProgressBar, but with an [orientation] @see [NeuIndicatorOrientation]
///
...
///
@immutable
class NeuIndicator extends StatefulWidget {
  final double percent;
  final double width;
  final double height;
  final EdgeInsets padding;
  final NeuIndicatorOrientation orientation;
  final NeuIndicatorStyle style;
  ...
  const NeuIndicator({
    Key? key,
    this.percent = 0.5,
    this.orientation = NeuIndicatorOrientation.vertical,
    this.height = double.maxFinite,
    this.padding = EdgeInsets.zero,
    this.width = double.maxFinite,
    this.style = const NeuIndicatorStyle(),
    this.duration = const Duration(milliseconds: 300),
    this.curve = Curves.easeOutCubic,
  }) : super(key: key);

  @override
  createState() => _NeuIndicatorState();
...
class _NeuIndicatorState extends State<NeuIndicator>
  ...
  @override
  void didUpdateWidget(NeuIndicator oldWidget) {
            ...
            builder: (_, __) {
              return FractionallySizedBox(
                heightFactor: widget.orientation ==
                        NeuIndicatorOrientation.vertical
                    ? _animation.value
                    : 1,
                widthFactor: widget.orientation ==
                        NeuIndicatorOrientation.horizontal
                    ? _animation.value
                    : 1,
