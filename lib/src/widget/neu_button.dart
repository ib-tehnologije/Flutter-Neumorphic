...
/// A Neumorphic Button
///
/// When pressed, it will fire a call to its [NeuButtonClickListener] click parameter
...
///
/// It takes a [NeuStyle] @see [Neumorphi]
///
/// ```
///  NeumorphicButton(
///          onClick: () {
...
class _NeuButtonState extends State<NeuButton> {
  ...
  void updateInitialStyle() {
    ...
    this.initialStyle = widget.style ??
        (appBarPresent
            ...
            : (theme.buttonStyle ?? const NeuStyle()));
  ...
  Widget _build(BuildContext context) {
    final appBarPresent = NeumorphicAppBarTheme.of(context) != null;
    final appBarTheme = NeuTheme.currentTheme(context).appBarTheme;
  ...
  double _getScale() {
    if (widget.pressed != null) {
      ...
      return widget.pressed!
          ? NeuButton.PRESSED_SCALE
          : NeuButton.UNPRESSED_SCALE;
    } else {
      return this.pressed
          ? NeuButton.PRESSED_SCALE
          : NeuButton.UNPRESSED_SCALE;
