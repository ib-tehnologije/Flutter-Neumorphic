...
class NeuAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// [NeuAppBar] will imply an appropriate widget. For example, if the [NeuAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [NeuAppBar]
  /// will use a [NeuBackButton] that calls [Navigator.maybePop].
  ...
  ///
  /// Defaults to [NeuAppBar.defaultSpacing].
  ...
  @override
  NeuAppBarState createState() => NeuAppBarState();

  bool _getEffectiveCenterTitle(ThemeData theme, NeuThemeData nTheme) {
...
class NeuAppBarState extends State<NeuAppBar> {
  @override
  Widget build(BuildContext context) {
    final ThemeData theme = Theme.of(context);
    final nTheme = NeuTheme.of(context);
