...
typedef void NeuSliderListener(double percent);

/// A style to customize the [NeuSlider]
///
...
class NeuSlider extends StatefulWidget {
  final NeuSliderStyle style;
  final double min;
  final double value;
  final double max;
  final double height;
  final NeuSliderListener? onChanged;
  final NeuSliderListener? onChangeStart;
  final NeuSliderListener? onChangeEnd;
  ...
  NeuSlider({
    Key? key,
    this.style = const NeuSliderStyle(),
    this.min = 0,
    this.value = 0,
    this.max = 10,
    this.height = 15,
