...
abstract class NeuAbstractEmbossPainterCache {
  Offset? _cacheOffset;
  ...
  NeuLightSource? _cacheLightSource; //store the old style lightsource

  NeuLightSource? _lightSource; //used to draw
  NeuLightSource get lightSource =>
      _lightSource ?? NeuLightSource.bottom; //used to draw
  bool updateLightSource(
      NeuLightSource newLightSource, bool newOppositeShadowLightSource) {
