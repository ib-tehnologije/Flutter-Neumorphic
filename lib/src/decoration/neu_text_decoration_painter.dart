...
import 'cache/neu_painter_cache.dart';
import 'neu_box_decoration_helper.dart';
...
class NeumorphicDecorationTextPainter extends BoxPainter {
      ...
      ..pushStyle(ui.TextStyle(
        foreground: _gradientPaint
          ..shader = getGradientShader(
            ...
            source: style.shape == NeuShape.concave
  ...
  void _drawGradient(
      {required Canvas canvas, required Offset offset, required Path path}) {
    if (style.shape == NeuShape.concave ||
        style.shape == NeuShape.convex) {
      canvas
